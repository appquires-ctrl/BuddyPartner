...
class _UserManagementScreenState extends ConsumerState<UserManagementScreen> {
                    ...
                    children: [
                      LayoutBuilder(
                        builder: (context, constraints) {
                          final width = constraints.maxWidth > 1300
                                ...
                                children: [
                                  ...
                                  ...usersState.users.map((user) {
                                    ...
                                    final spendableBalance =
                                        user['spendable_balance'] ?? 0;
                                    final earnedBalance =
                                        user['earned_balance'] ?? 0;
                                    final isSubscribed =
                                    ...
                                    final audioMinutes =
                                        user['audio_minutes'] ??
                                        ((user['audio_seconds'] ?? 0) ~/ 60);
                                    final videoMinutes =
                                        user['video_minutes'] ??
                                        ((user['video_seconds'] ?? 0) ~/ 60);
                                    ...
                                    if (expiresAtStr != null) {
                                      try {
                                        expiryFormatted = DateFormat(
                                          'MMM dd, yyyy',
                                        ).format(DateTime.parse(expiresAtStr));
                                      } catch (_) {}
                                    }
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            phone,
                                            style:
                                                AdminTheme.tabularNumeralStyle,
                                            maxLines: 1,
                                            ...
                                            child: isSubscribed
                                                ? Tooltip(
                                                    message:
                                                        ...
                                                        ? 'VIP valid until $expiryFormatted'
                                                        : 'VIP Active',
                                                    child: Container(
                                                      padding:
                                                          const EdgeInsets.symmetric(
  ...
  void _showResetQuotaDialog(
    ...
    final audioMinutes =
        user['audio_minutes'] ?? ((user['audio_seconds'] ?? 0) ~/ 60);
    final videoMinutes =
        user['video_minutes'] ?? ((user['video_seconds'] ?? 0) ~/ 60);
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 4),
                              Text(
                                'Audio: $audioMinutes / 200 minutes',
                                style: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                                ),
                                  ...
                                  if (context.mounted) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          success
                                              ? 'Call quota successfully reset for $userName!'
                                              : 'Failed to reset call quota',
                                        ),
                                  ...
                                  if (context.mounted) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          success
                                              ? 'Successfully credited $amount coins to $userName!'
  ...
  void _showGiveSubscriptionDialog(
    BuildContext context,
    WidgetRef ref,
    Map<String, dynamic> user,
  ) {
                                  ...
                                  if (context.mounted) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          success
                                              ? 'Successfully granted 1-Year VIP to $userName!'
              ...
              builder: (context, ref, child) {
                ...
                return detailAsync.when(
                  data: (user) {
                    ...
                    final callStats =
                        user['callStats'] as Map<String, dynamic>? ?? {};
                    final coinBal =
                        user['coinBalance'] ?? userSummary['coin_balance'] ?? 0;
                    final activeSub =
                    ...
                    if (activeSub != null && activeSub['expires_at'] != null) {
                      try {
                        subExpiry = DateFormat(
                          'MMM dd, yyyy',
                        ).format(DateTime.parse(activeSub['expires_at']));
                      } catch (_) {}
                    }
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton.icon(
                                      onPressed: () {
                                        Navigator.of(context).pop();
                                        _showGiveCoinsDialog(context, ref, {
                                          ...userSummary,
                          ...
                          Builder(
                            builder: (context) {
                              final callUsage =
                                  user['callUsage'] as Map<String, dynamic>?;
                              final audioUsage =
                                  callUsage?['audio'] as Map<String, dynamic>?;
                              final videoUsage =
                                  callUsage?['video'] as Map<String, dynamic>?;
                              ...
                              final audioCapped =
                                  audioUsage?['isCapped'] == true;
                              final videoCapped =
                                  videoUsage?['isCapped'] == true;
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: LinearProgressIndicator(
                                        value: (audioUsed / audioCap).clamp(
                                          0.0,
                                          1.0,
                                        ),
                                    ...
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(4),
                                      child: LinearProgressIndicator(
                                        value: (videoUsed / videoCap).clamp(
                                          0.0,
                                          1.0,
                                        ),
                                        backgroundColor: AdminColors.border,
                          ...
                          Text(
                            'Total Call Duration: ${callStats['total_duration'] ?? 0}s',
                          ),
                          const SizedBox(height: 16),
                          const Text(
                            'Report History Against User:',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(height: 8),
                          reports.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    ...
                                    return ListTile(
                                      ...
                                      subtitle: Text(
                                        'By: ${r['reporter_name'] ?? 'Anonymous'} • ${r['description'] ?? ''}',
                                      ),
                                    );
                                  },
                                ),
