...
/// Helper class to notify GoRouter to refresh its route when the Supabase auth state changes.
...
/// appRouter maps routing pathways for the onboarding flow, detailed profiles, calling screens, and tabs shell.
final GoRouter appRouter = GoRouter(
  navigatorKey: rootNavigatorKey,
  initialLocation: RouteNames.splash,
  refreshListenable: _isTest
      ? null
  ...
  redirect: (context, state) {
    ...
    if (!isLoggedIn) {
      ...
      // Authenticated: if on onboarding/auth pages, go to home
      if (isAuthRoute) {
