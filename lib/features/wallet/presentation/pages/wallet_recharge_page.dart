    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          padding: const EdgeInsets.only(left: AppSpacing.space16, right: AppSpacing.space16, top: 8, bottom: 120),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: const [
                        Icon(Icons.check_circle_outline_rounded, color: Color(0xFFB7F4D8), size: 14),
                        SizedBox(width: 6),
                        Text(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Paid Calls Earnings', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                            Text(
              ...
              ListView.separated(
                ...
                separatorBuilder: (ctx, i) => const SizedBox(height: 9),
                itemBuilder: (ctx, i) {
                  final pack = _packs[i];
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Get ${pack.totalCoins} Coins total',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.edit_note_rounded, color: Color(0xFF7C6AEF), size: 22),
                    const SizedBox(width: 8),
                    Expanded(
                      child: TextField(
