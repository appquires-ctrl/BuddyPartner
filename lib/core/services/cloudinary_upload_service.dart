...
class CloudinaryUploadService {
  ...
  /// Prompts gallery image picker, validates size, and uploads securely via backend.
  /// Returns the HTTPS image URL string on success, or null on cancel/error.
  static Future<String?> pickAndUploadAvatar({
    ...
    // Secure backend route: uploads to storage and returns URL
    try {
      ...
      if (kDebugMode) {
        debugPrint('Secure avatar upload failed: $backendErr');
      }
    }
